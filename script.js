...
const translations = {
  en: {
    ...
    discordTitle: 'Discord|bots', discordText: 'Custom communities with moderation, economy, tickets and more.', telegramTitle: 'Telegram|systems', telegramText: 'Automation, APIs, interactive buttons and storefronts that convert.', webTitle: 'Web design|& dev', webText: 'Landing pages, portfolios and custom web apps with a point of view.', otherTitle: 'Other digital|services', otherText: 'Hosting, configuration, integrations and the helpful stuff in between.', from5: 'From $5', from5: 'From $5', from5: 'From $5', letsTalk: 'Let’s talk',
